...
def test_vega_zeropoint_drops_nan_catalog_coords(tmp_path, monkeypatch):
    ...
    # pooled detections at the same finite positions, instrumental mag = vega - 5 (ZP = +5)
    sc = SkyCoord(ra[:n] * u.deg, dec[:n] * u.deg)
    zp = D._vega_zeropoint(o, "F212N", sc, vega[:n] - 5.0)
